...
yr.run = function(id, data, mode, args, nodeName) {
    ...
    if (args) {
        r = module.a.apply(module, [null, module, 0, [doc.root], mode, { a: {} }].concat(args));
    } else {
        r = module.a(null, module, 0, [ doc.root ], mode, { a: {} } );
    }
...
//  NOTE: ex applyValue.
Module.prototype.a = function applyValue(uuid, M, start, nodeset, mode, a0) {
    var r = '';
    ...
    for (var i0 = 0, l0 = nodeset.length; i0 < l0; i0++) {
        ...
        if (found) {
            ...
            if (args) {
                ...
                r += template.apply( M, [uuid, M, c0, i0, l0, a0].concat(args) );
            } else {
                r += template(uuid, M, c0, i0, l0, a0);
            }
        }
    }
